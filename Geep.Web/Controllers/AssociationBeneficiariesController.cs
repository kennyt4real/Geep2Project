...
namespace Geep.Web.Controllers
{
    ...
    {
        private ICrudInteger<AssociationBeneficiaryVm> _repo;

        public AssociationBeneficiariesController(ICrudInteger<AssociationBeneficiaryVm> repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Save(AssociationBeneficiaryVm vm)
        {
